...
不知道你注意没有，选择一套精心设计过的字体能极大地提升产品的视觉感受。然而不像拉丁语系翻来覆去就那么一点西文字符，中文字体要包含常用汉字动辄 10+ MB 的体积（比如，著名的 [思源黑体](https://github.com/adobe-fonts/source-han-sans/tree/release) 光常规字重就高达 23 MB）实在不适合内嵌到 Web。
