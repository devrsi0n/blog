...
author: Devrsi0n
date: '2019-01-05'
hero: /static/2019/a-guide-to-chinese-font-for-web-developer/font.jpg
excerpt: 选择正确的中文字体
---

<!-- > 头图来自[思源宋体](https://source.typekit.com/source-han-serif/cn/) -->

作为一名前端工程师，容易在还原设计师视觉稿时忽略字体，其实选择一套精心设计过的字体能极大地提升产品的视觉感受。今天就从这个很容易被忽略的细节入手，Web 开发需要了解的字体相关知识都梳理一遍。然而不像拉丁语系翻来覆去就那么一点西文字符，常见的字体就 100+ KB，而中文字体要包含常用汉字动辄 10+ MB 的体积（比如，著名的 [思源黑体](https://github.com/adobe-fonts/source-han-sans/tree/release) 光常规字重就高达 23 MB）实在不适合内嵌到 Web。
...
![](/static/2019/a-guide-to-chinese-font-for-web-developer/serif-and-sans-serif.png)

## 中文

![](/static/2019/a-guide-to-chinese-font-for-web-developer/serif-and-sans-serif-2.png)
...
![pingfang](/static/2019/a-guide-to-chinese-font-for-web-developer/pingfang.jpg)

PingFang 是 mac 系统自 OS X EL Capitan(10.11)自带的字体，字体清晰锐利。

#### Hiragino Sans GB 冬青黑体

![hiragino](/static/2019/a-guide-to-chinese-font-for-web-developer/hiragino.png)
...
![Microsoft YaHei](/static/2019/a-guide-to-chinese-font-for-web-developer/msyh.jpg)
...
![WenQuanYi Micro Hei](/static/2019/a-guide-to-chinese-font-for-web-developer/wenquanyi-microhei.png)
...
![](/static/2019/a-guide-to-chinese-font-for-web-developer/songti-sc&stsong.png)
...
![](/static/2019/a-guide-to-chinese-font-for-web-developer/simsun.png)

### Linux

#### AR PL Sungti 文鼎简报宋

![AR PL Sungti](/static/2019/a-guide-to-chinese-font-for-web-developer/ar-pl-sungti.png)

AR PL Sungti 文鼎简报宋是 Linux 上为数不多的高质量衬线字体。

## End

以上就是 Web 开发中系统自带的一些高质量的字体选择，如果你有更好的字体推荐，欢迎告知。:)
