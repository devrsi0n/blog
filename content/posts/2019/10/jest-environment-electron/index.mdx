...
自然，目前前端代码的单测 jest 最佳运行环境非[jest-runner/electron](https://github.com/facebook-atom/jest-electron-runner)莫属。造轮子一时爽，但也要多考虑用户生态啊，而且明显 Facebook 这个轮子适配性更广，使用体验更佳。😂
