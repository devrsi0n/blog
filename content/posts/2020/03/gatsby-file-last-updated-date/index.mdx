...
用 Gatsby 框架开发博客是一件颇为惬意的事情，可以很轻易的使用 React 社区的很多资源，定制化自由度颇高。最近想要给博客文章添加最近更新时间戳功能，但这个功能 Gatsby 框架和插件并不能直接提供（[issue](https://github.com/gatsbyjs/gatsby/issues/19272)），基于 Git 仓库本地 Markdown 文件的博客都会面临这个问题，下面是我的解决方案，思路也适用于类似 static site generator.
